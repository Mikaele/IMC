...
colab1=Colaborador.create(:user_id=>tec1.id,:perfil=>p_tec1,:cpf=>12323423,:telefone=>1231232,:endereco=>"Rua das flores")
colab2=Colaborador.create(:user_id=>tec2.id,:perfil=>p_tec2,:cpf=>12300423,:telefone=>1221232,:endereco=>"Rua das flores")
colab3=Colaborador.create(:user_id=>tec3.id,:perfil=>p_tec3,:cpf=>16688423,:telefone=>1223232,:endereco=>"Rua das flores")
admin=Colaborador.create(:user_id=>admin.id,:perfil=>p_admin,:cpf=>16685523,:telefone=>1225532,:endereco=>"Rua das flores")
