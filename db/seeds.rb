...
colab1=Colaborador.create(:user_id=>2,:perfil=>2,:cpf=>12323423,:telefone=>1231232,:endereco=>"Rua das flores")
colab2=Colaborador.create(:user_id=>3,:perfil=>3,:cpf=>12300423,:telefone=>1221232,:endereco=>"Rua das flores")
colab3=Colaborador.create(:user_id=>4,:perfil=>4,:cpf=>16688423,:telefone=>1223232,:endereco=>"Rua das flores")
admin=Colaborador.create(:user_id=>1,:perfil=>1,:cpf=>16685523,:telefone=>1225532,:endereco=>"Rua das flores")
